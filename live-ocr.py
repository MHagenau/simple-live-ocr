...
while True:
	...
	# Parsing the fram through the text recognition and saving the results in a DataFrame
	...
	# Showing the original image with the added boxes
...
# Stop the resolurces and closing all windows
vs.stop()
